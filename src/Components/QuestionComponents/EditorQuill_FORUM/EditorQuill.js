...
const CustomButtonFormula = () => (
	...
	<span className="editor-custom-toolbar-button">
		<Tooltip title="Formula Editor" placement="top">
...
const CustomButtonFormulaKaTex = () => (
	...
	<span className="editor-custom-toolbar-button">
		<Tooltip title="KaTex Editor" placement="top">
...
const CustomButtonImage = () => (
	<span className="editor-custom-toolbar-button">
		<Tooltip sx={{ color: "#444444" }} title="Inline Images" placement="top">
			{/* <svg  className={styles.CustomFormulaKaTexButton}>
				{/* <rect
					className="ql-fill"
					height="1.6"
					rx="0.8"
					...
					y="6.2"
				></rect> *
				<path className="ql-fill" d="M19 7v2.99s-1.99.01-2 0V7h-3s.01-1.99 0-2h3V2h2v3h3v2h-3zm-3 4V8h-3V5H5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2v-8h-3zM5 19l3-4 2 3 3-4 4 5H5z"></path>
