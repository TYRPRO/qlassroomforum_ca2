...
function TextEditor(props) {
	...
	return (
		<div id="wysiwyg_editor">
					...
					<div className="modal-content">
						...
						<div className="modal-body">
							<input
								...
								placeholder="https://www.qlassroom.ai/"
							></input>
						</div>
			...
			<EquationEditor
				toAppend={`eqn_container${eqnContainerCount}`}
				toIncrease={[eqnContainerCount, set_eqnContainerCount]}
				hide={hideEquationEditor}
				handleBlur={set_hideEquationEditor}
	...
	function modifyDesign(action) {
		if (action === "createLink") {
			saveSelection();
			var link_modal = new Modal(document.getElementById("add_url"), {
				backdrop: "static",
				keyboard: false,
			});
	...
	function createEqnContainer() {
		...
		document.getElementById("qn_body_textarea").innerHTML =
			document.getElementById("qn_body_textarea").innerHTML + node;
