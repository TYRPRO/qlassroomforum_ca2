...
var user = {
    ...
    getAll: function (callback) {
        ...
        User.findAll({ raw: true, attributes: ['user_id', 'first_name', 'last_name', 'email', 'roles', 'phone_number','verification_expiry','grade_id','stream_id','is_temp','last_login'] }).then(function (result) {
            return callback(null, result);
        })
    },
